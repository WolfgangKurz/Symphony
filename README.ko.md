...
---
- 소모품 목록을 정렬할 수 있습니다.
- 장비 선택에서 전용 장비를 항상 제일 앞에 표시할 수 있습니다.
- 전투원 목록에 추가 정렬 방식을 제공합니다.
---
- 전투원 상세 정보 화면에 이전/다음 버튼을 추가합니다.
- 전투원 즐겨찾기 기능을 전투원 상세 정보 화면 및 목록에 추가합니다.
- 전투원 스탯을 초기화 없이 뺄 수 있는 기능을 추가합니다.
---
...
- 기지 시설의 인벤토리 목록을 개선합니다 - `더 좋은 시설 인벤토리`
- 기지에 네비게이션 버튼을 제공합니다 - `기지 네비게이션 돌려내`
---
- 도감에서 투표 베네핏 효과를 보여주는 꾸미기 효과를 제공합니다.
---
...
- 기지에서 `일괄 수령`한 설비의 자동 재시작 기능을 제공합니다.
...
- 불필요한 파일의 로딩을 건너뛰는 빠른 로딩

### KeyMapping
키보드로 터치/클릭을 시뮬레이션하는 기능입니다.

- 키 맵핑

### AssetLoader
비-윈도우 에셋도 지원되는 커스텀 에셋 번들 로더입니다.
항상 불러오고 동작합니다.
